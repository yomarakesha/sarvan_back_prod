...
#Показать все транзакции (перемещение товара между локациями) с фильтром по дате и по пользователю (курьеру или складчику) и по типу операции (приемка, отгрузка, перемещение между складами).
